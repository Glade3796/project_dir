...
* @see https://v0.dev/t/Uq8NoXZwgm4
          ...
          <div className="grid gap-4">
            <div className="grid gap-2">
              ...
              <p className="text-muted-foreground">
                ...
                applications. With a strong background in full-stack development, I've honed my skills in a variety of
                technologies and frameworks, always striving to stay up-to-date with the latest industry trends.
              </p>
            </div>
            <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <div className="grid gap-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Contributed to the development of a mobile app using React Native and Firebase. Gained
                        experience in agile software development practices.
                      </p>
                    </CardContent>
                    <CardFooter>
                      <span className="text-xs text-muted-foreground">2019 - 2020</span>
                    </CardFooter>
                  </Card>
                </div>
              </div>
              <div className="grid gap-2">
                ...
                <div className="grid gap-4">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        Graduated with a focus on software engineering and algorithms.
                      </p>
                    </CardContent>
                    <CardFooter>
                ...
                <div className="grid gap-4">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>A modern and responsive portfolio website</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground">
                        Designed and developed a personal portfolio website using React, Next.js, and Tailwind CSS.
                        Showcased my work and provided information about my background and skills.
                      </p>
                    </CardContent>
                    <CardFooter>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>A simple and intuitive task management application</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground">
                        Built a Todo application using React, Redux, and Firebase. Implemented features like task
                        creation, completion, and deletion, as well as user authentication.
                      </p>
                    </CardContent>
                    <CardFooter>
                      <Link href="#" className="text-primary" prefetch={false}>
